...
def return_read_json_file():
    return [{'id': 441945886, 'state': 'EXECUTED',
            ...
            {'id': 895315941, 'state': 'EXECUTED',
             ...
             'from': 'Visa Classic 6831982476737658',
             'to': 'Visa Platinum 8990922113665229'},
            {'id': 596171168, 'state': 'EXECUTED',
             'date': '2018-07-11T02:26:18.671407',
             'operationAmount': {'amount': '79931.03',
                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
             'description': 'Открытие вклада',
             'to': 'Счет 72082042523231456215'},
            {'id': 716496732, 'state': 'EXECUTED',
            ...
            {'id': 608117766, 'state': 'CANCELED',
             'date': '2018-10-08T09:05:05.282282',
             'operationAmount': {'amount': '77302.31',
                                 'currency': {'name': 'USD', 'code': 'USD'}},
             'description': 'Перевод с карты на счет',
            ...
            {'id': 816266176, 'state': 'CANCELED',
             'date': '2018-06-24T00:46:32.422648',
             'operationAmount': {'amount': '60030.73',
                                 'currency': {'name': 'USD', 'code': 'USD'}},
             'description': 'Перевод организации',
            ...
            {'id': 207126257, 'state': 'EXECUTED',
             'date': '2019-07-15T11:47:40.496961',
             'operationAmount': {'amount': '92688.46',
                                 'currency': {'name': 'USD', 'code': 'USD'}},
             'description': 'Открытие вклада',
             'to': 'Счет 35737585785074382265'},
            {'id': 957763565, 'state': 'EXECUTED',
...
@pytest.fixture
def bank_search():
    return [{'date': '2018-06-30T02:08:58.425572',
             'description': 'Перевод организации',
             'from': 'Счет 75106830613657916952',
             'id': 939719570,
             'operationAmount': {'amount': '9824.07',
