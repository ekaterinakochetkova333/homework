...
def test_filter_by_state(data_for_processing, state, expected_result):
    """Функция проверки маскировки карты и счета"""
    assert filter_by_state(data_for_processing, state) == expected_result


@pytest.mark.parametrize("is_reverse, expected_result", [
    (True, [
